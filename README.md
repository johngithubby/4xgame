...
- The minigame now renders the player as a visible generated three-soldier formation with rotatable 3D armored bodies, face/cap/headset details, backpacks, cyan glow accents, limbs, and distinct held weapons, with flat survivor reference shells kept out of runtime squads.
- The generated survivor rigs provide distinct visible 3D weapon anchors: leader rifle, left-wing shotgun, and right-wing SMG.
...
- Survivor limbs now inherit the procedural walking bob/roll, and selected soldiers rotate their 3D body, helmet, arms, and weapon toward the target with a brief recoil when their muzzle fires, while zombies use a slower in-place shamble.
...
- Current EditMode test coverage includes Phase 1 gameplay rules, generated survivor weapon/muzzle rules, muzzle-origin shot events, visible zombie-sized rotatable 3D armored survivor bodies with face/cap meshes and real depth, visible stride/body-rotation/target-aim/recoil rules, Phase 2 progression/save/mission completion rules, bio-lab, hangar, training, and living-quarters upgrade timer rules, the local daily objective, advanced mission content, and Phase 3 hero inventory rules.
