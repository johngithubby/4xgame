...
- `PhaseThreeHeroTests.cs`: Verifies gameplay hero rewards, hero XP/level progression, manual hero equip state, hero stat bonuses, save persistence, and invalid equipped hero repair.
