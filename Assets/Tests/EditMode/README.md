...
- `PhaseTwoProgressionTests.cs`: Verifies local coin collection, HQ upgrade costs and timers, HQ completion, invalid timer repair, minigame bonuses, and save/load persistence.
