...
- `PhaseOneGameplayTests.cs`: Verifies gate modifiers, lane selection rules, zombie defeat, basic win/loss state evaluation, and level unlock definition selection.
