...
- `PhaseOneSceneBuilder.cs`: Rebuilds the Phase 1 level asset, materials, Unity scene, runtime-matched three-person imported Humanoid survivor squad with serialized dark wardrobe presets and obsolete flat cards suppressed, optional HUD marker, perspective chase camera, anchor-matched HUD, UI/end-screen layout, and build settings.
