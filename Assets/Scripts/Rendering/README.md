...
- `PrototypeMaterialFactory.cs`: Creates tinted placeholder materials for runtime-generated prototype geometry by probing a short list of common Unity shaders.
