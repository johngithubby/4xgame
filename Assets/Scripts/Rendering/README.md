...
- `PrototypeCharacterFactory.cs`: Builds collider-free survivor squad and zombie character hierarchies from generated rounded primitives, including human heads, torsos, connected shoulder/hip/knee/ankle limb chains, high-contrast zombie leg materials, rifles, zombie faces, wounds, and armored zombie gear.
...
- `PrototypeHumanoidAnimator.cs`: Caches generated humanoid joint-chain transforms and applies procedural run/shamble poses with hip swing, connected knee flex, foot pitch, body bob, body roll, and head nod.
