...
- `PlayerProgression.cs`: Defines progression rules for collecting coins, claiming one minigame win reward per run, starting HQ upgrades, completing HQ timers, starting bio-lab, hangar, and training upgrades with the V6-1 duration curve, completing those building timers, selecting unlocked missions, tracking completed missions, labeling mission status/reward hints, unlocking the next mission after frontier wins up to mission 8, and converting HQ level into minigame bonuses.
