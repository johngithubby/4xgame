...
- `PlayerProgression.cs`: Defines progression rules for collecting coins, claiming one minigame win reward per run, starting HQ upgrades, completing HQ timers, selecting unlocked missions, tracking completed missions, labeling mission status/reward hints, unlocking the next mission after frontier wins up to mission 8, and converting HQ level into minigame bonuses.
