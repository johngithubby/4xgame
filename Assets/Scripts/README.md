...
- `Rendering/`: Contains shared placeholder material, collider-free geometry helpers, generated humanoid character construction, and generated survivor weapon profiles for runtime-generated scenes.
...
The runtime assembly owns the local Phase 1 minigame prototype, generated survivor weapon/muzzle visuals, Phase 2 base-building slice, first Phase 3 hero slice, local v2 mission progression, and local daily objective retention slice. Editor tooling references it only to rebuild or configure development scenes.
