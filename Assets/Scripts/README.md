...
The runtime assembly owns the local Phase 1 minigame prototype, Phase 2 base-building slice, first Phase 3 hero slice, local v2 mission progression, and local daily objective retention slice. Editor tooling references it only to rebuild or configure development scenes.
