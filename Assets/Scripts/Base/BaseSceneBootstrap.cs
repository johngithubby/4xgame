...
namespace LaneSurvivor.Base
{
    public sealed class BaseSceneBootstrap : MonoBehaviour
    {
        ...
        private static BaseHudController CreateHud()
        {
            ...
            Text titleText = CreateText(canvas.transform, "Title Text", "Base", font, new Vector2(0f, -24f), TextAnchor.UpperCenter);
            Text coinsText = CreateText(canvas.transform, "Coins Text", "Coins: 0", font, new Vector2(20f, -24f), TextAnchor.UpperLeft);
