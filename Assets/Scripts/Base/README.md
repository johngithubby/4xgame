...
- `BaseHudController.cs`: Displays local base state, owned hero panel, equipped hero state, and exposes collect, upgrade, play, equip hero, and development reset button actions.
