...
The save system is intentionally local-only. It repairs malformed or impossible local data to keep prototype scene startup resilient and includes a development reset helper, but it does not use accounts, cloud save, networking, or server validation in early phases.
